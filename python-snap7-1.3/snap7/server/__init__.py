...
class Server:
    ...
    def __init__(self, log: bool = True):
        ...
        # info = bytearray(b'\0x00\x01SNAP7-CONPOT\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02CPU 315-2 PN/DP\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x04Original Siemens Equipment\x00\x00\x00\x00\x00\x00\x00\x05S C-C2UR28922012\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x07CPU 315-2 PN/DP\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08MMC 267FF11F\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\t\x00*\xf6\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\n\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x0b')
        # data = wordlen_to_ctypes[WordLen.Byte.value] * len(info)
        # data = data.from_buffer(info)

        # self.library.Srv_SetSZL(self.pointer, 0x001c, data, len(data))
...
def _init_standard_values() -> bytearray:
    ...
    * Double Word
    ...
    string = "I am a Conpot S7 Server"  # len = 37
    ba[100] = 254
    ba[101] = len(string)
